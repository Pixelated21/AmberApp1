    ...
    <div class="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
        ...
        <div class="w-full h-100">
            ...
            <form class="mt-6" action="{{route('On-Register')}}" method="POST">
                ...
                <div class="mt-4">
                    <label class="block text-gray-700">Verify Password</label>
...
{{--            </button>--}}
            ...
            <p class="mt-8">Need an account? <a href="{{route('Login')}}" class="text-blue-500 hover:text-blue-700 font-semibold">Create an
                    account</a></p>
