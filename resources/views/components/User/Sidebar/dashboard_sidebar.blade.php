...
<div
    ...
    <div class="{{--overflow-y-hidden--}} overflow-x-hidden flex-grow">
            ...
            <span class="inline-flex justify-center items-center ml-4">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                   xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <span class="ml-2 text-sm tracking-wide truncate">Activity</span>
                    {{--                    <span--}}
                    {{--                        class="px-2 py-0.5 ml-auto text-xs font-medium tracking-wide text-indigo-500 bg-indigo-50 rounded-full">New</span>--}}
                </a>
            </li>
        ...
        @forelse($userEnrolled->student as $class )
            <li>
{{--                {{$class->classroom}}--}}
                <a href="{{route('student.c.show',[$class->classroom->class_id])}}"
                   class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
            <span class="inline-flex justify-center items-center ml-4">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                   xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round"
            ...
            @empty
                <li id="sideJoinClass">
                    <button
                       class="relative w-full flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
            <span class="inline-flex justify-center items-center ml-4">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                   xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">Join Desk</span>
                        {{--                    <span--}}
                        {{--                        class="px-2 py-0.5 ml-auto text-xs font-medium tracking-wide text-red-500 bg-red-50 rounded-full">1.2k</span>--}}
                    </button>
                </li>
            ...
            @empty
                ...
                <li id="sideCrtClass">
                    <button
                       class="relative flex w-full flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
            <span class="inline-flex justify-center items-center ml-4">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                   xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">Create Desk</span>
                    </button>
                </li>
            ...
            <li>
                <form action="{{route('Logout')}}" method="post"
                      class="relative flex flex-row w-full items-center h-11  focus:outline-none hover:bg-red-600 duration-300 text-gray-600 hover:text-white pr-6 border-l-4 border-transparent hover:border-indigo-500">
