...
{{--                <a class="px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg  md:mt-0 hover:bg-gray-200 focus:bg-blue-200 focus:outline-none duration-200 border hover:bg-red-500  hover:text-white"--}}
{{--                href="">--}}
{{--                    TODO BACK BTN--}}
                            ...
                            <div
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-2 gap-4">
                                    ...
                                    <button
                                        ...
                                        <div class="ml-3">
                                            <p class="font-semibold">Delete Homework</p>
                                        </div>
                                    </button>
